...
lifetimes: {
  ...
  methods: {
    showCaldenlar() {
      ...
      setSelectDays() {
          let {calendar, beSelectDateArr} = this.data;
          calendar['second'].forEach((day) => {
            if (beSelectDateArr.includes(day.date)) {
                day.selected = true;
            } else {
                day.selected = false;
            }
      ...
      bindDayTap(e) {
        let { month, year, beSelectDateArr } = this.data
          , time = this.countMonth(year, month)
        ...
        if (!beSelectDateArr.includes(beSelectDate)) {
            beSelectDateArr.push(beSelectDate);
        } else {
            beSelectDateArr = beSelectDateArr.filter((item) => item !== beSelectDate);
        }
        console.log('beSelectDateArr', beSelectDateArr);
        this.setData({
          beSelectDateArr: beSelectDateArr,
          showCaldenlar: false,
        });
        this.setSelectDays();
      },
